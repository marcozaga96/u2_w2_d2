...
import marcozagaria.u2_w2_d2.payloads.ExceptionPayload;
...
public class ExceptionsHandler {
    ...
    public ExceptionPayload handleGeneric(Exception ex) {
        ...
        return new ExceptionPayload("Problema lato server! Giuro che risolveremo presto!", LocalDateTime.now());
    }
}
